...
public class ImageLoad
{
    ...
    public static byte[] getNibbles(String text) throws UnsupportedEncodingException
    {
    ...
    public static void hideProperties(int length,BufferedImage signified) throws UnsupportedEncodingException
    {
        String sign = "signify!";
    ...
    {
        long maxStorableData = (long)Math.floor((signified.getHeight()*signified.getWidth()*(12.0)));//12.0/32
